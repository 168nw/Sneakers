        ...
        <div className="d-flex align-center">
          <img width={40} height={40} src="\img\logo.png" alt="Logo"/>
            <div className="ml-15">
              ...
              <p opacity-2>Магазин лучших кросовок</p>
            </div>
          </div>
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          <div className="card ">
            ...
            <img width="133" height="112" src='\img\sneakers\image 1.jpg' alt=''></img>
        ...
        <div className="card">
          <img width="133" height="112" src='\img\sneakers\image 3.jpg' alt=''></img>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column ">
              <span>Цена:</span>
        ...
        <div className="card">
          <img width="133" height="112" src='\img\sneakers\image 8.jpg' alt=''></img>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column ">
              <span>Цена:</span>
        ...
        <div className="card">
          <img width="133" height="112" src='\img\sneakers\image 5.jpg' alt=''></img>
          <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column ">
              <span>Цена:</span>
